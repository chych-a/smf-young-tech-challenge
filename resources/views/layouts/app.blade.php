...
<head>
    ...
    <title>@yield('title', 'SMF Young Tech Challenge')</title>
...
<div class="app-shell" id="app-shell">
    <aside class="sidebar" aria-label="Panel boczny">
        <div class="sidebar-head">
            <a href="{{ route('dashboard') }}" class="brand" aria-label="SMF OCR Panel">
        ...
        <nav class="nav-list" aria-label="Główna nawigacja">
            <a href="{{ route('dashboard') }}" class="nav-link {{ request()->routeIs('dashboard') ? 'is-active' : '' }}" title="Dashboard">
                <span class="nav-icon">
            ...
            <a href="{{ route('web.invoices.create') }}" class="nav-link {{ request()->routeIs('web.invoices.create') ? 'is-active' : '' }}" title="Upload OCR">
                <span class="nav-icon">
            ...
            <a href="{{ route('web.invoices.index') }}" class="nav-link {{ request()->routeIs('web.invoices.*') && ! request()->routeIs('web.invoices.create') ? 'is-active' : '' }}" title="Faktury">
                <span class="nav-icon">
            ...
            <a href="{{ route('web.products.index') }}" class="nav-link {{ request()->routeIs('web.products.*') ? 'is-active' : '' }}" title="Produkty">
                <span class="nav-icon">
    ...
    <main class="main-area">
        <div class="topbar">
            ...
            <div class="topbar-actions">
                ...
                <a href="{{ route('web.invoices.create') }}" class="btn btn-primary">Przetwórz dokument</a>
            </div>
        </div>
...
<div class="modal-backdrop" data-command-palette hidden>
    <div class="command-palette" role="dialog" aria-modal="true" aria-label="Command Palette">
        ...
        <div class="command-list" data-command-list>
            <a href="{{ route('dashboard') }}" class="command-item" data-command-item data-keywords="dashboard kokpit statystyki">Dashboard<span>Widok główny</span></a>
            <a href="{{ route('web.invoices.create') }}" class="command-item" data-command-item data-keywords="upload ocr faktura paragon dokument">Upload OCR<span>Przetwórz dokument</span></a>
            <a href="{{ route('web.invoices.index') }}" class="command-item" data-command-item data-keywords="faktury paragony dokumenty lista">Faktury i paragony<span>Lista dokumentów</span></a>
            <a href="{{ route('web.products.index') }}" class="command-item" data-command-item data-keywords="produkty crud tabela">Produkty<span>CRUD produktów</span></a>
